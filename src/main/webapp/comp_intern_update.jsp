...
<div class="signup-image">
					 <div class="rcorners3"> 
                            ...
                            <form action="InternCompUpdateServlet" method="post"class="register-form"id="register-form">
                       

                                              			<div class="user__details">         
                       
                 <h2 class="form-title">Update Internship Application</h2>
                            <input type="hidden" name="intern_id" value="<c:out value='${intern.intern_id}' />" />
                        					
									<div class="form-group">
									<input type="text" name="intern_role"style="width:450px" id="intern_role" value="${intern.intern_role}" required placeholder="Intern role"/></div>
							<div class="form-group">
									<input type="text" name="intern_description"style="width:450px" id="intern_description" value="${intern.intern_description}" required placeholder="Intern Description"/></div>
			
			
             		 <div class="form-group">
                			<div class="select">
							   <select name="intern_type" id="intern_type" >
							      <option selected disabled>Work Mode</option>
							...
							<div class="form-group">
							<input type="text" required name="intern_duration"style="width:450px;display:inline-block; text-decoration:none;" value="${intern.intern_duration}" id="intern_duration" placeholder="Enter Duration" /></div>
						        	
				
							<div class="form-group">
							<input type="text" required name="intern_stipend"style="width:450px;display:inline-block; text-decoration:none;" value="${intern.intern_stipend}" id="intern_stipend" placeholder="Monthly Stipend" /></div>
						        	
				
							<div class="form-group">
							<input type="text" required name="intern_location"style="width:450px;display:inline-block; text-decoration:none;" value="${intern.intern_location}" id="intern_location" placeholder="Location" /></div>
						        	
				
							<div class="form-group sub-main"style="width:100vh">
      						<button class="button-two"type="submit" style="margin:30px 0 30px 30px"class="form-submit" ><span>Submit</span></button>
   							 </div>
							</div>
