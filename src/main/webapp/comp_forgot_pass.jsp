			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						...
						<form class="card mt-4" action="CompFPServlet" method="POST">
						<div class="form-group">
							 <input class="form-control" style="width:400px;margin-bottom:30px;"type="hidden"placeholder="Enter your email address"value="<%=session.getAttribute("u_email") %>" name="c_email" id="email-for-pass" required>
						</div>
