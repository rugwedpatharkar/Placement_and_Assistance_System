...
<div class="signup-image">
		 <div class="rcorners3"> 
						   ...
						   <form action="UserEduRegServlet" method="post"class="register-form"id="register-form" enctype="multipart/form-data">
							
								<div class="user__details">
								
                       
                               
                 <h2 class="form-title">Add Educational Details</h2>
                 ...
                 <input type="hidden" name="user_uid" value="${uid}" />
						...
						<h1 style="margin-right:280px;width:100%" class="form-title">SSC Details</h1>
							...
							<div class="form-group"><input type="text" name="sscper"style="width:410px" id="sscper"placeholder="Enter Percentages" /></div>
							
							
							<div class="form-group"><input type="text" name="sscpy"style="width:410px" id="sscpy"placeholder="Enter Passing Year" /></div>
							...
							<div class="form-group"><input type="text" name="hscper"style="width:410px" id="hscper"placeholder="Enter Percentages" /></div>
							
							
							<div class="form-group"><input type="text" name="hscpy"style="width:410px" id="hscpy"placeholder="Enter Passing Year" /></div>
							
							
							<h1 style="margin-top:40px;margin-bottom:40px;width:100%"class="form-title">Graduation Details</h1>
				
							<div class="form-group"><input type="text" name="uguni"style="width:410px" id="uguni"placeholder="Enter University Name" /></div>
														
							
							<div class="form-group"><input type="text" name="ugcourse"style="width:410px" id="ugcourse" placeholder="Enter Course Name" /></div>
							
							
							<div class="form-group"><input type="text" name="ugper"style="width:410px" id="ugper"placeholder="Enter Percentage" /></div>
							
							
							<div class="form-group"><input type="text" name="ugpy"style="width:410px" id="ugpy"placeholder="Enter Passing Year" /></div>
							
							
							<h1 style="margin-top:20px;margin-right:80px;width:100%"class="form-title">Post-Graduation Details</h1>
							
							<div class="form-group"><input type="text" name="pguni"style="width:410px" id="pguni"placeholder="Enter University Name" /></div>
							
							<div class="form-group"><input type="text" name="pgcourse"style="width:410px" id="pgcourse"placeholder="Enter Course Name" /></div>
							
							
							<div class="form-group"><input type="text" name="pgper"style="width:410px" id="pgper"placeholder="Enter Percentage" /></div>
							
							
							<div class="form-group"><input type="text" name="pgpy"style="width:410px" id="pgpy"placeholder="Enter Passing Year" /></div>
							
							
													<div class="form-group sub-main"style="width:100vh">
						
      						<button class="button-two"type="submit" name="signup" style="margin:30px 0 30px 30px"id="signup"class="form-submit"  ><span>Register</span></button>
							</div>
							</div>
 ...
 <script src="vendor/jquery/jquery.min.js"></script>
	...
	else if(status == "infofirst"){
		swal("Please","Fill the Educational Information to complete the profile.","info");
	}
	</script>
<script
