          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
               ...
               <tr>
                ...
                <td width="2%">:</td>
                <td><%=session.getAttribute("c_name") %></td>
              </tr>
               <tr>
                <th width="100%">Company Username</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("c_uname") %></td>
              </tr>          
              <tr>
                <th width="100%">Company E-mail</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("c_email") %></td>
              </tr>
              <tr>
                <th width="100%">Company Contact No</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("c_mobno") %></td>
              </tr>
              <tr>
                <th width="100%">Company Address</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("c_address") %></td>
              </tr>
            </table>
          </div>
    </div>
     <button class="button-two"style="margin:30px 0 30px 30px"><a href="comp_update.jsp"style="text-decoration:none;color:white;">Update User Profile</a></button>
