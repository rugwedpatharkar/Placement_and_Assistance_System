...
<div class="signup-image" >
						<div class="rcorners3"> 
						 <form action="CompProfileDelServlet" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title">Delete Company Profile</h2>
                				   <h1 class="form-title"style="font-size:18px;font-weight:600"><%=session.getAttribute("c_name") %> ,  you are about to delete your account from system.</h1>
                				 <h1 class="form-title"style="font-size:15px;font-weight:400">Once deleted account cannot be recovered.</h1>
									<input type="hidden" name="cid" value="${cid}"/>
							
										
							<div class="form-group sub-main"style="width:100vh">
      						<button class="button-two"type="submit"formaction="uedudel"formaction="udel" style="margin:30px 0 30px 30px;background-color:rgb(164, 40, 40);display:inline-block;"class="form-submit" ><span>Delete</span></button>
   							
      						<a class="button-two" href="user_section.jsp"class="button-two" style="margin:30px 0 30px 30px;background-color:rgb(50,205,50);display:inline-block;text-decoration:none;"class="form-submit" ><span>Cancel</span></a>
   							 </div>
							</div>
