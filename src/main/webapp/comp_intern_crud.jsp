        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
						...
						<h2 class="title1" style="padding:0 0 0 0;margin:0 0 0 0 ">Internship section</h2>
					...
					<a href="comp_job.jsp" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>Applications</span></a>
						...
						<a href="InternCompListServlet?company_cid1=<%=session.getAttribute("cid") %>" class="button-two"style="width:130px;height:50px;text-decoration:none;background-color:rgb(50,205,50)" data-toggle="modal"><span>Refresh</span></a>			
                  
				<a href="comp_intern.jsp" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>Add Internships</span></a>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th  style="font-size:30px;color:black;width:100vh"> Internships </th>
             ...
             <a href="InternCompServletEdit1?intern_id=<c:out value='${intern.intern_id}' />"  data-toggle="modal">Update Internship Details</a>
                         
    			<a href="InternCompServletDelete?intern_id=<c:out value='${intern.intern_id}' />"  data-toggle="modal">Delete Internship</a>
