...
<div class="signup-image">
					<div class="rcorners3"> 
						 ...
						 <form action="InternCompAddServlet" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title" style="padding-right:30%">Internship Details</h2>
									<input type="hidden" name="company_cid1" value="${cid}"/>
									<input type="hidden" name="company_name" value="${c_name}"/>
							
										<div class="form-group">
									<input type="text" name="intern_role"style="width:450px" id="intern_role" required placeholder="Intern role"/></div>
							<div class="form-group">
									<input type="text" name="intern_description"style="width:450px" id="intern_description"  required placeholder="Intern Description"/></div>
             		 ...
             		 <div class="form-group">
							...
							<div class="form-group">
							<input type="text" required name="intern_duration"style="width:450px;display:inline-block; text-decoration:none;"  id="intern_duration" placeholder="Enter Duration" /></div>
						        	
				
							<div class="form-group">
							<input type="text" required name="intern_stipend"style="width:450px;display:inline-block; text-decoration:none;" id="intern_stipend" placeholder="Monthly Stipend" /></div>
						        	
				
							<div class="form-group">
							<input type="text" required name="intern_location"style="width:450px;display:inline-block; text-decoration:none;"  id="intern_location" placeholder="Location" /></div>
