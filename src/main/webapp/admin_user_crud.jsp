        ...
        <div class="table-wrapper">
            <div class="table-title"style="margin-bittom:200vh">
                <div class="row">
						...
						<h2 class="title1">User section</h2>
				
                  
						<a href="<%=request.getContextPath()%>/UserServletList" class="button-two"style="width:130px;height:50px;text-decoration:none;background-color:rgb(50,205,50)" data-toggle="modal"><span>Refresh</span></a>			
				<a href="<%=request.getContextPath()%>/UserServletNew" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>User Registration</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach var="user" items="${listUser}">
                                ...
                                <tr>
                                    <td>
                                        <c:out value="${user.u_name}" />
                                    </td>
                                     <td>
                                        <c:out value="${user.u_email}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.u_mobno}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.u_status}" />
                                    </td>
                                         <td>
                            <a href="UserServletDelete?uid=<c:out value='${user.uid}' />" style="font-size:14px;color:red" data-toggle="modal"><i class="material-icons" style="font-size:30px;color:red">delete</i></a>
