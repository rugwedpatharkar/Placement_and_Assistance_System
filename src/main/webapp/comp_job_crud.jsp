        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
						...
						<h2 class="title1">Job section</h2>
						
							<a href="comp_job.jsp" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>Applications</span></a>
				
						<a href="JobCompListServlet?company_cid1=<%=session.getAttribute("cid") %>" class="button-two"style="width:130px;height:50px;text-decoration:none;background-color:rgb(50,205,50)" data-toggle="modal"><span>Refresh</span></a>			
                  
				<a href="comp_job.jsp" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>Add Jobs</span></a>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th  style="font-size:30px;color:black;width:100vh">Job Roles</th>
                ...
                <tbody>
                             ...
                             <c:forEach var="job" items="${jobs}">
                               ...
                               <div class="table_head1" >
                               				...
                               				<c:out value="${job.job_role}"/>
                                        <br><span style="font-size:14px;font-weight: 600;color:black">Description : </span><c:out value="${job.job_description}"/>
                                        <br><span style="font-size:14px;font-weight: 600;color:black" >Working Type : </span><c:out value="${job.job_type}"/>
                                        <br><span style="font-size:14px;font-weight: 600;color:black">Office Location : </span><c:out value="${job.job_location}"/>
                                        <br><span style="font-size:14px;font-weight: 600;color:black">Experience required : </span><c:out value="${job.job_xp}"/>
                                        ...
                                        <div class="vertical-center">
							              ...
							              <a href="JobCompServletEdit1?job_id=<c:out value='${job.job_id}' />" data-toggle="modal">Update Job Details</a>
							               
							    		<a href="JobCompServletDelete?job_id=<c:out value='${job.job_id}' />"  data-toggle="modal">Delete Job Profile</a>
							                                    
							            <a href=""  data-toggle="modal"><span>Applications</span></a>
							                     </div>
