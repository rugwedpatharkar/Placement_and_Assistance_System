			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						...
						<form class="form-horizontal" action="CompNPServlet" method="POST">
						<h2 class="form-title" style="width:100vh">Enter new password</h2>
						
								<div class="form-group">
							 <input class="form-control"id="password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter Password" name="c_pass" id="email-for-pass" required>
						</div>
						<div class="form-group">
							 <input class="form-control"id="confirm_password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter again to confirm" name="c_pass2" id="email-for-pass" required>
