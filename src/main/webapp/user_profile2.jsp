     ...
     <button class="button-two"style="margin:30px 0 30px 30px"><a href="user_update.jsp"style="text-decoration:none;color:white;">Update User Profile</a></button>
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm">
          ...
          <div class="card-body pt-0">
            <span class="profile_title">10th details</span>
            <table class="table table-bordered">
               ...
               <tr>
                ...
                <td width="2%">:</td>
                <td><%=session.getAttribute("sscper") %></td>
              </tr>
               <tr>
                <th width="100%">Passing Year</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("sscpy") %></td>
              </tr>
                              </table>
                              </div>
    <span class="profile_title">12th details</span>
            <table class="table table-bordered" >
               <tr>
                <th width="100%">Stream</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("hscstream") %></td>
              </tr>
               <tr>
                <th width="100%">Percentage</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("hscper") %></td>
              </tr>
              <tr>
                <th width="100%">Passing Year</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("hscpy") %></td>
              </tr>
            </table>
               <span class="profile_title" >Graduation details</span>
              <table class="table table-bordered">
              <tr>
                <th width="100%">University Name</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("uguni") %></td>
              </tr>
              <tr>
                <th width="100%">Course</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("ugcourse") %></td>
              </tr>
              <tr>
                <th width="100%">Percentage</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("ugper") %></td>
              </tr>
              <tr>
                <th width="100%">Passing Year</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("ugpy") %></td>
              </tr>
                              </table>         
                              <span class="profile_title">Post-graduation details</span>
            <table class="table table-bordered">
              <tr>
                <th width="100%">University Name</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("pguni") %></td>
              </tr>
              <tr>
                <th width="100%">Course</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("pgcourse") %></td>
              </tr>
              <tr>
                <th width="100%">Percentage</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("pgper") %></td>
              </tr>
              <tr>
                <th width="100%">Passing Year</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("pgpy") %></td>
              </tr>
            </table>
          </div>
        </div>
      </div>
         <button class="button-two"style="margin:30px 0 30px 30px"><a href="user_edu_update.jsp"style="text-decoration:none;color:white;">Update User Profile</a></button>
