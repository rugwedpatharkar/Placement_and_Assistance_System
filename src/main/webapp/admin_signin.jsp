			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						...
						<form method="POST" action="AdminLoginServlet" class="register-form" id="alogin">
							<div class="form-group">
									<input type="text" style="width:350px"name="a_uname" id="a_uname"placeholder="Enter Username" />
							</div>
							<div class="form-group">
								<input type="password" style="width:350px"name="a_pass" id="a_pass"placeholder="Enter Password" />
						<a href="admin_forgot_pass.jsp" style="text-decoration:none;font-size:15px;font-wieght:600;">Forgotten Password?</a>
							</div>
...
<script src="vendor/jquery/jquery.min.js"></script>
	...
	else if(status == "invalidAuname"){
		swal("Sorry","Please enter Username.","error");
	}
	else if(status == "invalidAupass"){
