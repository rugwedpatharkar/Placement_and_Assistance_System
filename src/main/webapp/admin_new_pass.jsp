...
<div class="main" style="width:100%">
		...
		<section class="sign-in" style="margin:0 35px 0 35px;">
			<div class="container">
				<div class="signin-content">
					...
					<ol class="list-unstyled">
						...
						next page. </span></li>
						<li style="font-weight: bold;"><span class="text-primary text-medium">3. Enter the password to complete the process.</span></li>
					...
					<div class="signin-form" >
						...
						<form class="form-horizontal" action="AdminNPServlet" method="POST">
						<h2 class="form-title" style="width:100vh">Enter new password</h2>
						
								<div class="form-group">
							 <input class="form-control"id="password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter Password" name="a_pass" id="email-for-pass" required>
						</div>
						<div class="form-group">
							 <input class="form-control"id="confirm_password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter again to confirm" name="a_pass2" id="email-for-pass" required>
							 <span style="font-size:18px;color:red;" id="confirm_password_msg"></span>
								...
								<div class="form-group sub-main">
      								<button style="width:200px;"class="button-two"type="submit"class="form-submit" ><span>Reset Password</span></button></div>
							</form>
							</div>
					</div>
				</div>
