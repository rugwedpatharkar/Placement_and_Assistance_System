...
<div class="signup-image">
					 <div class="rcorners3"> 
                            ...
                            <form action="JobCompUpdateServlet" method="post"class="register-form"id="register-form">
                       

                                              			<div class="user__details">         
                       
                 <h2 class="form-title">Update Job Application</h2>
                            <input type="hidden" name="job_id" value="<c:out value='${job.job_id}' />" />
                        					
									<div class="form-group">
									<input type="text" name="job_role"style="width:450px" id="job_role" value="${job.job_role}" required placeholder="Job role"/></div>
							<div class="form-group">
									<input type="text" name="job_description"style="width:450px" id="job_description" value="${job.job_description}" required placeholder="Job Description"/></div>
             		 ...
             		 <div class="form-group">
							...
							<div class="form-group">
							<input type="text" required name="job_location"style="width:450px;display:inline-block; text-decoration:none;" value="${job.job_location}" id="job_location" placeholder="Location" /></div>
							               
							<div class="form-group">
							<input type="text" required name="job_xp"style="width:450px" id="job_xp" value="${job.job_xp}" placeholder="Work experience required" /></div>
