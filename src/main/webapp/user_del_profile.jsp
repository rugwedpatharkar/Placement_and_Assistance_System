...
<div class="signup-image" >
							<div class="rcorners3"> 
									 <form action="UserProfileDelServlet" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title">Delete User Profile</h2>
                				   <h1 class="form-title"style="font-size:18px;font-weight:600"><%=session.getAttribute("u_name") %> ,  you are about to delete your account from system.</h1>
