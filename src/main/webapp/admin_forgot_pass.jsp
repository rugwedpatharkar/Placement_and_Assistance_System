			...
			<div class="container">
				<div class="signin-content">
					...
					<ol class="list-unstyled">
						<li style="font-weight: bold;"><span class="text-primary text-medium">1. </span>A verification code has been sent to<h1>"<%=session.getAttribute("a_email") %>" .</h1></li>
						...
						<a href="admin_signin.jsp" style="text-decoration:none;font-size:25px;font-wieght:600"><li>Back to the Login Page</li></a>
					</ol>
					...
					<div class="signin-form" >
						...
						<form class="card mt-4" action="AdminFPServlet" method="POST">
						<div class="form-group">
							 <input class="form-control" style="width:400px;margin-bottom:30px;"type="hidden"placeholder="Enter your email address" value="<%=session.getAttribute("a_email") %>"name="a_email" id="email-for-pass" required>
						</div>
