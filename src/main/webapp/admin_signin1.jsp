			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						 <div class="rcorners4"style="width:100%"> 
						<h2 class="form-title" style="width:100vh">Two_facter Authentication</h2>
						<p>A verification code has been sent to<h1> "<%=session.getAttribute("a_email") %>"</h1></p>
						<form class="card mt-4" action="AdminLoginProcess1Servlet" method="POST">
