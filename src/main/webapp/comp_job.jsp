...
<div class="signup-image">
					<div class="rcorners3"> 
						 ...
						 <form action="JobCompAddServlet" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title" style="padding-right:30%">Job Details</h2>
									<input type="hidden" name="company_cid1" value="${cid}"/>
							
									<div class="form-group">
									<input type="text" name="job_role"style="width:450px" id="job_role" required placeholder="Job role"/></div>
							<div class="form-group">
									<input type="text" name="job_description"style="width:450px" id="job_description" required placeholder="Job Description"/></div>
             		 ...
             		 <div class="form-group">
							...
							<div class="form-group">
							<input type="text" required name="job_location"style="width:450px;display:inline-block; text-decoration:none;"  id="job_location" placeholder="Location" /></div>
							               
							<div class="form-group">
							<input type="text" required name="job_xp"style="width:450px" id="job_xp" placeholder="Work experience required" /></div>
