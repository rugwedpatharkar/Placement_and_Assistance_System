			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						...
						<form method="POST" action="CompLoginServlet" class="register-form" id="login-form">
							<div class="form-group">
									<input type="text" style="width:350px"name="c_uname" id="c_uname"placeholder="Enter Username" />
							</div>
							<div class="form-group">
								<input type="password" style="width:350px"name="c_pass" id="c_pass"placeholder="Enter Password" />
							<a href="comp_forgot_pass.jsp" style="text-decoration:none;font-size:15px;font-wieght:600;">Forgotten Password?</a>
							
							</div>
							
							<div class="form-group sub-main">
      								<button style="width:150px"class="button-two"type="submit" name="signup" id="signup"class="form-submit" value="Register"><span>Log in</span></button>
   							 </div>
...
<script src="vendor/jquery/jquery.min.js"></script>
	...
	else if(status == "invalidCuname"){
		swal("Sorry","Please enter Username.","error");
	}
	else if(status == "invalidCpass"){
