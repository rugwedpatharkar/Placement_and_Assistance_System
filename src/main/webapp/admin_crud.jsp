        ...
        <div class="table-wrapper">
            <div class="table-title"style="margin-bittom:200vh">
                <div class="row">
						...
						<h2 class="title1">Admin section</h2>
				
                  
						<a href="<%=request.getContextPath()%>/AdminServletList" class="button-two"style="width:130px;height:50px;text-decoration:none;background-color:rgb(50,205,50)" data-toggle="modal"><span>Refresh</span></a>			
				<a href="<%=request.getContextPath()%>/AdminServletNew" class="button-two"style="width:220px;height:50px;text-decoration:none" data-toggle="modal"><span>Admin Registration</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach var="admin" items="${listAdmin}">
                                ...
                                <tr>
                                    <td>
                                        <c:out value="${admin.aid}" />
                                    </td>
                                    <td>
                                        <c:out value="${admin.a_name}" />
                                    </td>
                                     <td>
                                        <c:out value="${admin.a_uname}" />
                                    </td>
                                    <td>
                                        <c:out value="${admin.a_email}" />
                                        </td>
                                         <td>
                            <a href="AdminServletDelete?aid=<c:out value='${admin.aid}' />" style="font-size:14px;color:red" data-toggle="modal"><i class="material-icons" style="font-size:30px;color:red">delete</i></a>
                        </td>
