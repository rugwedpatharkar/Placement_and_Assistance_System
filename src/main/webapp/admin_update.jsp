...
<div class="signup-image" style="margin-right:100px">
						 ...
						 <form action="AdminUpdateServlet" method="post">
                				 ...
                				 <h2 class="form-title">Update Admin Profile</h2>
									<input type="hidden" name="aid" value="${aid}"/>
							
									<div class="form-group">
									<input type="text" name="a_name"style="width:450px" id="a_name" value="${a_name}" required placeholder="Enter Full Name"/></div>
							<div class="form-group">
							<input type="text" name="a_uname"style="width:450px" id="a_uname"value="${a_uname}"required placeholder="Enter Username"/></div>
							...
							<div class="form-group">
							<input type="password" id="password" required name="a_pass" style="width:450px"class="form-control" placeholder="Password" value="${a_pass}"></div> 
							
							
							<div class="form-group">
							<input type="password" id="confirm_password" required name="a_pass2" style="width:450px"class="form-control" placeholder="Confirm password" />
							 <span style="font-size:18px;color:red;" id="confirm_password_msg"></span>
							</div>
							<div class="form-group">
							<input type="email" required name="a_email"style="width:450px;display:inline-block; text-decoration:none;" value="${a_email}" id="a_email" placeholder="Your Email" /></div>
							               
						
										
							<div class="form-group sub-main"style="width:115vh">
      						<button class="button-two"type="submit" name="update" style="margin:30px 0 30px 30px"class="form-submit" ><span>Submit</span></button>
   							 </div>
							</div>
