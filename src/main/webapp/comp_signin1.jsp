			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form" >
						...
						<p>A verification code has been sent to<h1> "<%=session.getAttribute("c_email") %>"</h1></p>
						<form class="card mt-4" action="CompLoginProcess1Servlet" method="POST">
							 <input class="form-control" style="width:400px;margin-bottom:30px;"type="hidden"placeholder="Enter your email address" value="<%=session.getAttribute("c_email") %>"name="c_email" id="email-for-pass" required>
