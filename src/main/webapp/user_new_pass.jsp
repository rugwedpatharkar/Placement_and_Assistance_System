			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="rcorners4"> 
						...
						<form class="form-horizontal" action="UserNPServlet" method="POST">
						<h2 class="form-title" style="width:100vh">Enter new password</h2>
						
								<div class="form-group">
							 <input class="form-control"id="password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter Password" name="u_pass" id="email-for-pass" required>
						</div>
						<div class="form-group">
							 <input class="form-control"id="confirm_password" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter again to confirm" name="u_pass2" id="email-for-pass" required>
