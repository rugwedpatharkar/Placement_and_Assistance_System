      ...
      <div class="col-lg-8">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="far fa-clone pr-1"></i>Admin Profile</h3>
          </div>
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
               <tr>
                <th width="100%">Admin ID</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("aid") %></td>
              </tr>
               <tr>
                <th width="100%">Name</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("a_name") %></td>
              </tr>
               <tr>
                <th width="100%">Username</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("a_uname") %></td>
              </tr>
              
              <tr>
                <th width="100%">E-mail</th>
                <td width="2%">:</td>
                <td><%=session.getAttribute("a_email") %></td>
              </tr>
              
            </table>
          </div>
    </div>
     <button class="button-two"style="margin:30px 0 30px 30px"><a href="admin_update.jsp"style="text-decoration:none;color:white;">Update profile</a></button>
