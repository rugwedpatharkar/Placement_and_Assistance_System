...
<div class="signup-image" style="margin-right:100px">
						 <div class="rcorners2"style="width:110vh"> 
						
						
									 <form action="AdminServletDelete" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title">Delete Admin Profile</h2>
                				   <h1 class="form-title"style="font-size:18px;font-weight:600"><%=session.getAttribute("a_name") %> ,  you are about to delete your account from system.</h1>
							...
							<div class="form-group sub-main"style="width:100vh">
      						<button class="button-two"type="submit"formaction="uedudel"formaction="udel" style="margin:30px 0 30px 30px;background-color:rgb(164, 40, 40);"class="form-submit" ><span>Delete</span></button>
   							
      						<a class="button-two" href="user_section.jsp" style="margin:30px 0 30px 30px;background-color:rgb(50,205,50);text-decoration:none;height:55px"class="form-submit" ><span>Cancel</span></a>
   							 </div>
							</div>
