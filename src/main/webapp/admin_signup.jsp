...
<div class="signup-image" style="margin-right:100px">
                            ...
                            <form action="AdminRegisterServlet" method="post"class="register-form"id="register-form" enctype="multipart/form-data">
                       			<div class="user__details">         
                				 <h2 class="form-title">Admin Registration</h2>
                     
									<div class="form-group"><input type="text" name="a_name"style="width:450px" id="a_name"   placeholder="Enter Full Name"/></div>
							<div class="form-group"><input type="text" name="a_uname"style="width:450px" id="a_uname"  placeholder="Enter Username"/></div>
             
                			
							
							
							
							<div class="form-group"><input type="password" id="password"  name="a_pass" style="width:450px"class="form-control" placeholder="Password"></div> 
							
							
							<div class="form-group"><input type="password" id="confirm_password"  name="a_pass2" style="width:450px"class="form-control" placeholder="Confirm password" />
							 <span style="font-size:18px;color:red;" id="confirm_password_msg"></span>
							</div>
							<div class="form-group"><input type="email" name="a_email"style="width:450px;"  style="display:inline-block; text-decoration:none;" id="a_email" placeholder="Your Email" /></div>
