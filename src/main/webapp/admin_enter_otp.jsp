			...
			<div class="container">
				<div class="signin-content">
					...
					<ol class="list-unstyled">
						...
						<li style="font-weight: bold;"><span class="text-primary text-medium">2. Enter the OTP on the 
						next page. </span></li>
					...
					<div class="signin-form" >
						...
						<h2 class="form-title" style="width:100vh">Enter OTP</h2>
									<%if(request.getAttribute("message")!=null)
		  			{
		  				out.print("<p class='text-danger ml-1'>"+request.getAttribute("message")+"</p>");
								...
								<form id="register-form" action="AdminValidateOtpServlet" role="form" autocomplete="off"
									class="form" method="post">

									<div class="form-group">
							 <input class="form-control" style="width:400px;margin-bottom:30px;"type="text"placeholder="Enter OTP" name="otp" id="otp" required>
						</div>
						
									<div class="form-group sub-main">
      								<button style="width:150px"class="button-two"type="submit"class="form-submit" ><span>Verify OTP</span></button>
      							 </div>
...
<script src="vendor/jquery/jquery.min.js"></script>
	...
	if(status == "succed"){
		swal("OTP","has been sent to your device","succed");
	}
	</script>
<script
