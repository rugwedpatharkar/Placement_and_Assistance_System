...
<center><div class="about"style="width:80%;text-align:center;" >
      <div class="home_tag">Our Objective,</div>
      Welcome to Placement and Assistance System. Our system is based on making Students from different college get placed in Top-Rated IT Companies like Infosys, Wipro, Tata Consultancy Services, Capgemini, Reliance Jio, Legato,
            Mphasis, etc.,. We provide opportunity for bright minds to get placed in top brand companies.Placement and Assistance System , it goes without saying that much more has to be aimed at. Raising the level of information and support for the students, wider exposure
...
<div class="home_tag">Top Companies are hiring now</div>
