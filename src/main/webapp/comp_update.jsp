...
<div class="signup-image" >
						 ...
						 <form action="CompUpdateServlet" method="post">
                       			<div class="user__details">         
                				 <h2 class="form-title">Update Company Profile</h2>
									<input type="hidden" name="cid" value="${cid}"/>
							
									<div class="form-group">
									<input type="text" name="c_name"style="width:450px" id="c_name" value="${c_name}" required placeholder="Enter Full Name"/></div>
							<div class="form-group">
							<input type="text" name="c_uname"style="width:450px" id="c_uname"value="${c_uname}"required placeholder="Enter Username"/></div>
             		
							<div class="form-group">
							<input type="password" id="password" required name="c_pass" style="width:450px"class="form-control" placeholder="Password" value="${c_pass}"></div> 
							
							
							<div class="form-group">
							<input type="password" id="confirm_password" required name="c_pass2" style="width:450px"class="form-control" placeholder="Confirm password" />
							 <span style="font-size:18px;color:red;" id="confirm_password_msg"></span>
							</div>
							<div class="form-group">
							<input type="email" required name="c_email"style="width:450px;display:inline-block; text-decoration:none;" value="${c_email}" id="c_email" placeholder="Your Email" /></div>
							               
							<div class="form-group">
							<input type="text" required name="c_mobno"style="width:450px" id="c_mobno" value="${c_mobno}" placeholder="Contact no" /></div>
							
							
						<div class="form-group">
						<input type="text" required name="c_address"style="width:450px" id="c_address"value="${c_address}" placeholder="Enter Address" /></div>
